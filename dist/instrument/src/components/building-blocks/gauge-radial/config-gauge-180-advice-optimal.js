...
export const BuildingBlocksGaugeRadialConfigGauge180AdviceOptimal = React.forwardRef(function BuildingBlocksGaugeRadialConfigGauge180AdviceOptimal(props, ref) {
