...
export const BuildingBlocksCompassConfigCompassArcAdviceOptimal = React.forwardRef(function BuildingBlocksCompassConfigCompassArcAdviceOptimal(props, ref) {
