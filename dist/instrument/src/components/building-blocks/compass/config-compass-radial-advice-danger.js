...
export const BuildingBlocksCompassConfigCompassRadialAdviceDanger = React.forwardRef(function BuildingBlocksCompassConfigCompassRadialAdviceDanger(props, ref) {
