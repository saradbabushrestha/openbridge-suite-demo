...
export const BuildingBlocksMotionConfigPitchrollPitchAdviceFrame = React.forwardRef(function BuildingBlocksMotionConfigPitchrollPitchAdviceFrame(props, ref) {
