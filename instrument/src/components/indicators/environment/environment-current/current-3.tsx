...
export type IndicatorsEnvironmentEnvironmentCurrentCurrent3Props = OpenBridgeAssetProps;

export const IndicatorsEnvironmentEnvironmentCurrentCurrent3 = React.forwardRef(function IndicatorsEnvironmentEnvironmentCurrentCurrent3(props: IndicatorsEnvironmentEnvironmentCurrentCurrent3Props, ref: any) {
  return renderOpenBridgeSvg(svgMarkup, { ...props, ref, intrinsicWidth: 24.0, intrinsicHeight: 24.0 });
});

export default IndicatorsEnvironmentEnvironmentCurrentCurrent3;
