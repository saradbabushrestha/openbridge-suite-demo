...
export type IndicatorsPropulsionPropulsionRudderStateOffPropulsionRudderProps = OpenBridgeAssetProps;

export const IndicatorsPropulsionPropulsionRudderStateOffPropulsionRudder = React.forwardRef(function IndicatorsPropulsionPropulsionRudderStateOffPropulsionRudder(props: IndicatorsPropulsionPropulsionRudderStateOffPropulsionRudderProps, ref: any) {
  return renderOpenBridgeSvg(svgMarkup, { ...props, ref, intrinsicWidth: 48.0, intrinsicHeight: 48.0 });
});

export default IndicatorsPropulsionPropulsionRudderStateOffPropulsionRudder;
