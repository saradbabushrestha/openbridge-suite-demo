...
export type BuildingBlocksSailConfigSailAdviceFrameProps = OpenBridgeAssetProps;

export const BuildingBlocksSailConfigSailAdviceFrame = React.forwardRef(function BuildingBlocksSailConfigSailAdviceFrame(props: BuildingBlocksSailConfigSailAdviceFrameProps, ref: any) {
