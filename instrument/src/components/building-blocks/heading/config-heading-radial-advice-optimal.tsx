...
export type BuildingBlocksHeadingConfigHeadingRadialAdviceOptimalProps = OpenBridgeAssetProps;

export const BuildingBlocksHeadingConfigHeadingRadialAdviceOptimal = React.forwardRef(function BuildingBlocksHeadingConfigHeadingRadialAdviceOptimal(props: BuildingBlocksHeadingConfigHeadingRadialAdviceOptimalProps, ref: any) {
